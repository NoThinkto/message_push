...
-- ============================================
-- 机会流程已深读分析记录
-- 用于避免同一标题/URL 在短时间内反复进入正文级 AI 分析
-- ============================================
CREATE TABLE IF NOT EXISTS opportunity_analyzed_items (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
-- ============================================
-- 机会流程每日推送计数
-- 用于展示“当天第 X 次 opportunity 推送”
-- ============================================
CREATE TABLE IF NOT EXISTS opportunity_push_records (
...
CREATE INDEX IF NOT EXISTS idx_opportunity_analyzed_last
ON opportunity_analyzed_items(last_analyzed_at);

CREATE INDEX IF NOT EXISTS idx_opportunity_analyzed_status
ON opportunity_analyzed_items(last_status);
